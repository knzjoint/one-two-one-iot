<template>
  ...
  <a-col :span="12">
    <a-form-item label="最小值" :rules="[{ required: true, message: '请输入最小值!', trigger: 'blur' },]">
      <a-input v-model:value="dataFormat.min" type="number"></a-input>
    </a-form-item>
  </a-col>

  <a-col :span="12">
    <a-form-item label="最大值" :rules="[{ required: true, message: '请输入最大值!', trigger: 'blur' },]">
      <a-input v-model:value="dataFormat.max" type="number"></a-input>
    </a-form-item>
  </a-col>

  <a-col :span="12">
    <a-form-item label="步长" :rules="[{ required: true, message: '请输入步长!', trigger: 'blur' },]">
      <a-input v-model:value="dataFormat.step" type="number"></a-input>
    </a-form-item>
  </a-col>
</template>
